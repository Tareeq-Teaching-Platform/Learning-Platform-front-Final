...
const ClassesTable = () => {
  ...
  return (
    ...
    <div className='w-full flex'>
                        <button onClick={()=>setCreatingClass(true)} className='btn bg-green-400 shadow- border-0 hover:scale-101 duration-100 ml-auto'>Create Class <PlusCircleIcon/></button>
                        </div>
                ...
                render: (data, type, row) => {
                  ...
                  return `
                    <div class="flex gap-2">
                      <button class="btn bg-red-500 text-white border-0 btn-error btn-sm delete-btn" data-class-id="${classData.id}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                        </svg>
                      </button>
                      <button class="btn bg-yellow-300 border-0 btn-sm edit-btn" data-class-id="${classData.id}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
